...
import { FaBolt, FaTachometerAlt, FaHistory, FaArrowRight, FaCar } from 'react-icons/fa'
  ...
  return (
    <div className='car-section-wrapper py-5'>
      ...
      <div className='container text-center mb-4'>
        ...
        <h1 className='car-premium-title'>Featured Models</h1>
        <p className='car-premium-subtitle'>
          Handpicked selections representing the absolute pinnacle of modern BMW engineering, intelligence, and track heritage.
        </p>
      </div>
